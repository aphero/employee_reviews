...
class EmployeeReviewsTest < Minitest::Test
  ...
  def test_add_employee_review_07
    ...
    dept.add_employee("Zeke", "zeke@spoonflower.com", "919-123-4567", 40000)
  ...
  def test_is_employee_good_08
    ...
    dept.add_employee("David", "dwoodward@spoonflower.com", "919-234-4567", 50000)
  ...
  def test_give_employee_raise_09
    dept = Department.new("Print Ops")
    dept.add_employee("Josh", "jmckelvey@spoonflower.com", "919-345-1234", 40000)
    dept.set_sat("Josh", true)
    dept.give_raise("Josh", 1.05)
    assert_equal dept.get_employee_salary("Josh"), 42000
  end

  def test_give_dept_raises_010
    dept = Department.new("Print Ops")
    dept.add_employee("Josh", "jmckelvey@spoonflower.com", "919-345-1234", 40000)
    dept.add_employee("David", "dwoodward@spoonflower.com", "919-234-4567", 50000)
    dept.add_employee("Zeke", "zeke@spoonflower.com", "919-123-4567", 40000)
    dept.add_employee("Bork", "swedishchef@spoonflower.com", "919-123-4567", 30000)
    dept.set_sat("Josh", true)
    dept.set_sat("David", false)
    dept.set_sat("Zeke", true)
    dept.set_sat("Bork", false)
    dept.give_dept_raises(40000)
    assert_equal dept.get_employee_salary("Josh"), 60000
    refute_equal dept.get_employee_salary("David"), 70000
    assert_equal dept.get_employee_salary("Zeke"), 60000
    refute_equal dept.get_employee_salary("Bork"), 50000
  end
end
